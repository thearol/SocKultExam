...
#Getting priors
get_prior(answer ~ dif_blue:unique, data = ldata)
...
prior =  c(
  ...
  #prior(normal(0,2), class = "sigma"), #Why does this not work? 
  prior(normal(0,2), class = "b"),
  prior(normal(0,2), class = "b", coef = "dif_blue"),
  prior(normal(0,2), class = "b", coef = "unique1_Oliver"),
  prior(normal(0,2), class = "b", coef = "unique10_andersweile"),
  prior(normal(0,2), class = "b", coef = "unique10_simonmoller"),
  prior(normal(0,2), class = "b", coef = "unique11_andersweile"),
  prior(normal(0,2), class = "b", coef = "unique11_Matilde"),
  prior(normal(0,2), class = "b", coef = "unique12_simonmoller"),
  prior(normal(0,2), class = "b", coef = "unique12_Telma"),
  prior(normal(0,2), class = "b", coef = "unique13_Malte"),
  prior(normal(0,2), class = "b", coef = "unique13_Sara"),
  prior(normal(0,2), class = "b", coef = "unique14_kenneth"),
  prior(normal(0,2), class = "b", coef = "unique14_signekirk"),
  prior(normal(0,2), class = "b", coef = "unique15_kenneth"),
  prior(normal(0,2), class = "b", coef = "unique15_Malte"),
  prior(normal(0,2), class = "b", coef = "unique16_Sara"),
  prior(normal(0,2), class = "b", coef = "unique16_signekirk"),
  prior(normal(0,2), class = "b", coef = "unique17_Fred"),
  prior(normal(0,2), class = "b", coef = "unique17_seb"),
  prior(normal(0,2), class = "b", coef = "unique18_Ida"),
  prior(normal(0,2), class = "b", coef = "unique18_SigneR"),
  prior(normal(0,2), class = "b", coef = "unique19_seb"),
  prior(normal(0,2), class = "b", coef = "unique19_SigneR"),
  prior(normal(0,2), class = "b", coef = "unique2_Britta"),
  prior(normal(0,2), class = "b", coef = "unique2_Oliver"),
  prior(normal(0,2), class = "b", coef = "unique20_Fred"),
  prior(normal(0,2), class = "b", coef = "unique20_Ida"),
  prior(normal(0,2), class = "b", coef = "unique21_laura"),
  prior(normal(0,2), class = "b", coef = "unique21_Toby"),
  prior(normal(0,2), class = "b", coef = "unique22_Karoline"),
  prior(normal(0,2), class = "b", coef = "unique23_Karoline"),
  prior(normal(0,2), class = "b", coef = "unique23_laura"),
  prior(normal(0,2), class = "b", coef = "unique24_Lasse"),
  prior(normal(0,2), class = "b", coef = "unique22_Lasse"),
  prior(normal(0,2), class = "b", coef = "unique24_Toby"),
  prior(normal(0,2), class = "b", coef = "unique25_Amalie"),
  prior(normal(0,2), class = "b", coef = "unique26_Simon"),
  prior(normal(0,2), class = "b", coef = "unique27_Esben"),
  prior(normal(0,2), class = "b", coef = "unique27_Simon"),
  prior(normal(0,2), class = "b", coef = "unique25_Esben"),
  prior(normal(0,2), class = "b", coef = "unique26_Astrid"),
  prior(normal(0,2), class = "b", coef = "unique28_Amalie"),
  prior(normal(0,2), class = "b", coef = "unique28_Astrid"),
  prior(normal(0,2), class = "b", coef = "unique29_Emma"),
  prior(normal(0,2), class = "b", coef = "unique29_Theasmom"),
  prior(normal(0,2), class = "b", coef = "unique3_Britta"),
  prior(normal(0,2), class = "b", coef = "unique3_Katrine"),
  prior(normal(0,2), class = "b", coef = "unique30_Jan"),
  prior(normal(0,2), class = "b", coef = "unique30_John"),
  prior(normal(0,2), class = "b", coef = "unique31_Emma"),
  prior(normal(0,2), class = "b", coef = "unique32_John"),
  prior(normal(0,2), class = "b", coef = "unique32_Theasmom"),
  prior(normal(0,2), class = "b", coef = "unique31_Jan"),
  prior(normal(0,2), class = "b", coef = "unique33_Ane"),
  prior(normal(0,2), class = "b", coef = "unique33_Laurits"),
  prior(normal(0,2), class = "b", coef = "unique34_Magnus"),
  prior(normal(0,2), class = "b", coef = "unique34_Nanna"),
  prior(normal(0,2), class = "b", coef = "unique35_Laurits"),
  prior(normal(0,2), class = "b", coef = "unique35_Magnus"),
  prior(normal(0,2), class = "b", coef = "unique36_Ane"),
  prior(normal(0,2), class = "b", coef = "unique36_Nanna"),
  prior(normal(0,2), class = "b", coef = "unique37_andersh"),
  prior(normal(0,2), class = "b", coef = "unique37_larsk"),
  prior(normal(0,2), class = "b", coef = "unique38_annas"),
  prior(normal(0,2), class = "b", coef = "unique38_anneed"),
  prior(normal(0,2), class = "b", coef = "unique39_annas"),
  prior(normal(0,2), class = "b", coef = "unique39_larsk"),
  prior(normal(0,2), class = "b", coef = "unique4_Katrine"),
  prior(normal(0,2), class = "b", coef = "unique4_Michael"),
  prior(normal(0,2), class = "b", coef = "unique40_andersh"),
  prior(normal(0,2), class = "b", coef = "unique40_anneed"),
  prior(normal(0,2), class = "b", coef = "unique5_mikkel"),
  prior(normal(0,2), class = "b", coef = "unique5_stephanie"),
  prior(normal(0,2), class = "b", coef = "unique6_emil"),
  prior(normal(0,2), class = "b", coef = "unique6_nina"),
  prior(normal(0,2), class = "b", coef = "unique7_nina"),
  prior(normal(0,2), class = "b", coef = "unique7_stephanie"),
  prior(normal(0,2), class = "b", coef = "unique8_emil"),
  prior(normal(0,2), class = "b", coef = "unique8_mikkel"),
  prior(normal(0,2), class = "b", coef = "unique9_Matilde"),
  prior(normal(0,2), class = "b", coef = "unique9_Telma")
)
  
#Prior predictive check - for answer
  prior_check <- brm( answer ~ dif_blue + unique, prior = prior,
           data = ldata, sample_prior = "only",iter = 4000, family = "bernoulli")

#Prior predictive check - for correct
  prior_check_c <- brm(Correct ~ dif_blue_abs + unique, prior = prior,
           data = ldata, sample_prior = "only",iter = 4000, family = "bernoulli")

#Making the model - using answer
  m_p <- brm(
    answer ~ dif_blue + unique,
    data = ldata,
    prior = prior,
    family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
    seed = 123 # Adding a seed makes results reproducible.
...
#Making the model - using correct
  ...
  #Saving summary in temporary dataframe
  betas <- data.frame(m$prior[1:81, 3])
  
  #Removing unique from the string
  betas$m.prior.1.81..3. <- str_remove(betas$prior_check.prior.1.81..3., "unique")
  
  #Insert betas in dataframe
  betas$Est_individual_p_answer <- fixef(m_p)[1:81]
  betas$Est_idividual_p_correct <- fixef(m_p_c)[1:81]
  
  #Insert the Intercept
  #betas$str_remove.betas...unique..[1,] <-  "Intercept"
  
  #Renaming column names
  names(betas) <- c("unique_ID_right", "Est_individual_p_right", "Est_idividual_p_correct_right")
  
  #Merge the betas with the results dataframe for right individual
  Results<- left_join(Results, betas, by = "unique_ID_right")
  
  
  #Renaming column names
  names(betas) <- c("unique_ID_left", "Est_individual_p_left", "Est_idividual_p_correct_left")
  
  
  #Merge the betas with the results dataframe
  Results <- left_join(Results, betas, by = "unique_ID_left")
  
  
```

```{r creating model with partial pooling, joint}
...
#Saving the estimates in the results dataframe
```
